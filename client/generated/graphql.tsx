...
export type PostSnippetFragment = { __typename?: 'Post', id: number, createdAt: string, updatedAt: string, title: string, textSnippet: string, imagePublicId: string, imageUrl: string, points: number, voteStatus?: number | null, creator: { __typename?: 'User', id: number, username: string } };
...
export type CancelVoteMutation = { __typename?: 'Mutation', cancelVote: boolean };
...
export type PostQuery = { __typename?: 'Query', post?: { __typename?: 'Post', id: number, title: string, text: string, points: number, voteStatus?: number | null, createdAt: string, updatedAt: string, imageUrl: string, imagePublicId: string, creator: { __typename?: 'User', id: number, username: string } } | null };
...
export type PostsQuery = { __typename?: 'Query', posts: { __typename?: 'PaginatedPosts', hasMore: boolean, posts: Array<{ __typename?: 'Post', id: number, createdAt: string, updatedAt: string, title: string, textSnippet: string, imagePublicId: string, imageUrl: string, points: number, voteStatus?: number | null, creator: { __typename?: 'User', id: number, username: string } }> } };
...
export const CancelVoteDocument = gql`
    mutation CancelVote($value: Int!, $postId: Int!) {
  cancelVote(value: $value, postId: $postId)
}
    `;

export function useCancelVoteMutation() {
  return Urql.useMutation<CancelVoteMutation, CancelVoteMutationVariables>(CancelVoteDocument);
};
